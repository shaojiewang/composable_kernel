...
using fmha_bwd_dot_do_o_trait_0 = ck_tile::TileFmhaBwdOGradDotOTraits<true,
                                                    false,
                                                    2>;
...
using fmha_bwd_dot_do_o_0 = typename ck_tile::BlockFmhaBwdOGradDotO<
...
using dot_do_o_trait_0 = fmha_bwd_dot_do_o_traits_<32, ck_tile::bf16_t, true, true, false>;
