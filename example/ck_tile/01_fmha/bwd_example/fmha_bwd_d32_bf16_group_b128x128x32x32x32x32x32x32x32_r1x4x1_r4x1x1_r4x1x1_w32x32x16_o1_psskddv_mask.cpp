...
using dq_dk_dv_trait_0 = fmha_bwd_dq_dk_dv_traits_<32, ck_tile::bf16_t, true, ck_tile::BlockFmhaBwdPipelineEnum::QSKSVROGradS, fmha_mask_0, ck_tile::BlockAttentionBiasEnum::NO_BIAS, false, false, true, true, true, true>;
